...
def main():
    ...
    parser.add_argument("--full-mesh", help="Optional: output full mesh with slopes colored")
    parser.add_argument("--deformed-slopes", help="Optional: output deformed slope regions")
