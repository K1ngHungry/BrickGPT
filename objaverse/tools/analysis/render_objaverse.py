...
def render_assets(input_dir=None, force_all=False):
    ...
    target_dir = Path(input_dir) if input_dir else ASSETS_DIR / "current" / "mesh-results"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input-dir", "-i", type=str, default=None, help="Directory containing .ldr files (default: assets/mesh_results)")
